module cache(
    ...
    input               cpu_read,
    input               cpu_write,
    input       [29:0]  cpu_addr,   //1 word is 4 bytes, assume last 2 bits are 0. 
    ...
    output reg	[27:0]  mem_addr,   //block size= 4 words 
...
//==== wire/reg ================================
    ...
    reg 	[154:0] blocks_w[7:0], blocks_r[7:0]; //8 index cache, 28-3(index bits)=25=tag bits
