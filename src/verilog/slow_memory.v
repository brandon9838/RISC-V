...
module slow_memory#(
    parameter OFFSET = 5047, //80752~80960,/16=>5047~5060
    parameter MEM_NUM = 52,
    ...
    // internal FF
    reg             [31:0] mem      [0:MEM_NUM*4-1];
    reg             [31:0] mem_next [0:MEM_NUM*4-1];
    ...
    wire [27:0] mem_addr_temp=mem_addr-OFFSET;
    always@( negedge clk ) begin
        mem_read_r  <=  mem_read;
        mem_write_r <=  mem_write;
        mem_addr_r  <=  mem_addr_temp;
